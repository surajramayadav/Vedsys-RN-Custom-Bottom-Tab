      ...
      <View style={{flexDirection: 'row'}}>
        <View style={{height: vh(15), width: vw(24)}}>
          <ImageBackground
            ...
            resizeMode="cover"
            source={require('./Grocery.png')}></ImageBackground>
        </View>
        <View
          style={{
          ...
          <Text style={styles.main}>Balaji Departmental Stores</Text>
          ...
          <View
            ...
            <Text style={styles.alt}>Self and Home Delivery Available</Text>
          </View>
        </View>
      </View>
    </View>
