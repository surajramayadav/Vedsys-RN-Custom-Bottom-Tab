    ...
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
      ...
      <Modal isVisible={isModalVisible} style={{alignItems:"center"}}>
        <View style={styles.found}>
            <Image source={require('../../assets/media.png')} style={{marginBottom:20}}/>
          <Text style={{fontSize:rF(3), marginBottom:5,color:"#003366",fontWeight: 'bold'}}>Allow to store Files and Media</Text>
